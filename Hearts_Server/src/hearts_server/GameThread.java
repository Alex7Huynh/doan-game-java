...
public class GameThread extends Thread {
    ...
    int QuaTrinhTraoDoiBai(int VanBai, int LDi) {
        ...
        try {
            ...
            } else if (MessageClient[1].indexOf("%2_Chuon") != -1 || MessageClient[1].startsWith("2_Chuon")) {
                int th = VanBai % 4;
                switch (th) {
                    case 1: {
                        LuotDi = 2;
            ...
            } else if (MessageClient[2].indexOf("%2_Chuon") != -1 || MessageClient[2].startsWith("2_Chuon")) {
                int th = VanBai % 4;
                switch (th) {
                    case 1: {
                        LuotDi = 3;
            ...
            } else if (MessageClient[3].indexOf("%2_Chuon") != -1 || MessageClient[3].startsWith("2_Chuon")) {
                int th = VanBai % 4;
                switch (th) {
                    case 1: {
                        LuotDi = 0;
