...
public class DTOConstantCard {
   ...
   // Qui định số lá bài của một bộ là 52 lá
   public static final int FACE_2 = 0; // Qui định con bài 2 = trọng số là 0: để sử lý con 2 chuồn(con thấp nhất)
   //Qui đinh con bài Q = trọng số là 10 để sử lý con Đầm bích: trừ 13
   ...
   // Qui định con bài 2 = trọng số là 0: để sử lý con 2 chuồn(con thấp nhất)
